...
def Botonclick(num):
            ...
            if num==0:
                ...
                if machine=="Papel":
                    ...
                    if x==3 and a<3:
                        ...
                        Label(wi,text="Derrota",font=("arial",20)).place(x=300,y=130)
                elif machine=="Tijera":
                    resultado = "Tu ganas"
                    resultado1.set(resultado)
                    global ab
                    ...
                    if a==3 and x<3:
                        ...
                        Label(win,text="Ganaste",font=("arial",20)).place(x=300,y=130)  
                elif machine=="Piedra":
                    resultado = "Empate"
                    resultado1.set(resultado)
            elif num==1:
                ...
                if machine=="Papel":
                    ...
                    if x==3 and a<3:
                        ...
                        wi.geometry("700x300")
                        wi.title("El juego de Piedra, Papel y Tijera")
                        Label(wi,text="Perdiste",font=("arial",20)).place(x=300,y=130)
                elif machine=="Piedra":
                    resultado = "Tu ganas"
                    resultado1.set(resultado)
                    global b
    ...
    b77=Entry(v,font=("arial",10,"bold"),width=10,bd=5,).place(x=100,y=215)
    ...
    Label(v,text="Maquina",font=("arial",15)).place(x=1100,y=60)
    Label(v,text="Tu",font=("arial",15)).place(x=1275,y=60)
    #Resultado Marcador
